"""
L99 Execution — Binance Adapter
Wraps ccxt Binance. Primary exchange (70% capital allocation).
"""
import logging
import time
...
logger = logging.getLogger("l99.execution.binance")
...
class BinanceExchange(ExchangeBase):
    ...
    def __init__(self) -> None:
        ...
        if config.TESTNET and hasattr(self._ex, "set_sandbox_mode"):
    ...
    def cancel_order(self, order_id: str, symbol: str) -> None:
        try:
            ...
            logger.warning("Binance cancel_order failed %s: %s", order_id, e)
