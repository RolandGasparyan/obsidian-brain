...
# ─────────────────────────────────────────────
# STRATEGY → PREFERRED ASSETS (empirical PF data)
# Strategies only trade on assets where they have proven PF > 1.0
# Empty list = no restriction (trades all available tokens)
# ─────────────────────────────────────────────
STRATEGY_PREFERRED_ASSETS = {
    # CMO: PF>1 only on meme/alt coins — AVOID BTC,ETH,XRP,BNB,INJ,SUI
    "CHANDE_MOMENTUM":      ["FLOKI/USDT","BOME/USDT","BONK/USDT","DOGE/USDT","WIF/USDT",
                             "OP/USDT","UNI/USDT","DOT/USDT","ATOM/USDT","ADA/USDT",
                             "SHIB/USDT","PEPE/USDT","LTC/USDT"],
    # ICT FVG: best on BOME, OP, ADA — avoid BTC/ETH
    "FAIR_VALUE_GAP":       ["BOME/USDT","OP/USDT","ADA/USDT","UNI/USDT","DOT/USDT",
                             "ATOM/USDT","FLOKI/USDT","WIF/USDT","DOGE/USDT","SOL/USDT"],
    # Squeeze Momentum: broad — avoid BTC/ETH/BNB
    "SQUEEZE_MOMENTUM":     ["FLOKI/USDT","BOME/USDT","BONK/USDT","WIF/USDT","DOGE/USDT",
                             "OP/USDT","ADA/USDT","DOT/USDT","ATOM/USDT","SOL/USDT",
                             "UNI/USDT","LTC/USDT","SHIB/USDT"],
    # Williams %R: elite on FLOKI, good on top 6
    "WILLIAMS_R_REVERSAL":  ["FLOKI/USDT","BOME/USDT","WIF/USDT","DOGE/USDT","OP/USDT","ADA/USDT"],
    # Parabolic SAR: PF 4.16 on WIF, 3.05 on FLOKI only
    "PARABOLIC_SAR":        ["WIF/USDT","FLOKI/USDT","BOME/USDT","BONK/USDT","DOGE/USDT"],
    # Keltner+RSI: best on OP (PF 2.39), DOT, ATOM
    "KELTNER_RSI":          ["OP/USDT","DOT/USDT","ATOM/USDT","ADA/USDT","UNI/USDT",
                             "SOL/USDT","LTC/USDT","FLOKI/USDT"],
    # BB Squeeze: PF 2.37 on DOGE only — restrict to DOGE
    "BB_SQUEEZE":           ["DOGE/USDT"],
    # Fibonacci: PF 2.48 on UNI, 2.33 on ATOM only
    "FIBONACCI_RETRACEMENT":["UNI/USDT","ATOM/USDT"],
    # CVD Absorption: avoid BTC/ETH — use on mid/alt caps
    "CVD_ABSORPTION":       ["DOT/USDT","ATOM/USDT","ADA/USDT","OP/USDT","SOL/USDT",
                             "LTC/USDT","UNI/USDT","DOGE/USDT"],
    # SuperTrend+MACD: worst PF (0.707) — restrict to DOGE only as last resort
    "SUPERTREND_MACD":      ["DOGE/USDT"],
    # Donchian: broad breakout — avoid BTC/ETH/BNB
    "DONCHIAN_BREAKOUT":    ["SOL/USDT","DOT/USDT","ATOM/USDT","ADA/USDT","OP/USDT",
                             "FLOKI/USDT","WIF/USDT","DOGE/USDT","LTC/USDT"],
    # Order Flow: broad — all top 10 assets
    "ORDER_FLOW":           ["FLOKI/USDT","BOME/USDT","WIF/USDT","DOGE/USDT","OP/USDT",
                             "ADA/USDT","DOT/USDT","ATOM/USDT","SOL/USDT","UNI/USDT",
                             "LTC/USDT","BONK/USDT","SHIB/USDT"],
    # HFT StatArb: broad scalp — avoid BTC/ETH
    "HFT_STAT_ARB":         ["SOL/USDT","DOT/USDT","ATOM/USDT","ADA/USDT","OP/USDT",
                             "FLOKI/USDT","WIF/USDT","DOGE/USDT","LTC/USDT","UNI/USDT"],
}
# Strategies NOT in this dict trade all available tokens (no restriction)
...
AGENT_CONFIGS = [
    ...
    # DELTA: BB_SQUEEZE → CMO (BB_SQUEEZE overall PF 0.826, CMO PF 1.278)
    {"name":"AGENT DELTA",   "strategy":"CHANDE_MOMENTUM",       "risk":"ULTRA_AGGRESSIVE"},
    # EPSILON: SUPERTREND_MACD → SQUEEZE_MOMENTUM (SuperTrend PF 0.707 — worst in engine)
    {"name":"AGENT EPSILON", "strategy":"SQUEEZE_MOMENTUM",       "risk":"BALANCED"},
    ...
    # PI: HEIKIN_ASHI_TREND → SQUEEZE_MOMENTUM (Heikin Ashi WR 37.7% — 2nd worst WR)
    {"name":"AGENT PI",      "strategy":"SQUEEZE_MOMENTUM",      "risk":"ULTRA_AGGRESSIVE"},
    ...
    # BETH: CVD_ABSORPTION → FAIR_VALUE_GAP (CVD losing -$24 in AM session; FVG PF 1.121)
    {"name":"AGENT BETH",    "strategy":"FAIR_VALUE_GAP",         "risk":"SAFE"},
...
class Agent:
    ...
    def try_open_trade(self, token, prices, tick):
        ...
        if direction == "NONE" or confirms < rm["min_conf"]:
            return
        # ── STRATEGY PREFERRED ASSETS FILTER (empirical PF-based) ──────────────
        preferred = STRATEGY_PREFERRED_ASSETS.get(self.strategy_key)
        if preferred and token not in preferred:
            return  # Skip tokens where this strategy has proven PF < 1.0
